...
\section*{Опыт работы}
\noindent
\years{2015-настоящее время}{Фриланс, \textbf{Java/C++ программист,\\Разработчик в области компьютерного зрения}
\begin{itemize}
...
\item{Модернизация \href{https://github.com/contrasetup/contra}{интерпретатора}, написанного на Java.}
\end{itemize}
}
...
\item{Основные технологии: C++, Java, OpenCV, PostgreSQL, Swing, Maven, Android NDK, Boost library, CMake, Git.}
\end{itemize}
}
...
\item{Проект: \href{http://www.ulmart.ru}{ulmart.ru} (\href{http://dz.ru/portfolio/clients/ulmart/release_1-0/}{ссылка 1}, \href{http://dz.ru/portfolio/clients/ulmart/release_2-0/}{ссылка 2}).}
...
\textit{Основные языки}: Java, C++.\\
\textit{Анализ данных}: Matlab.\\
\textit{Скриптовые языки}: Shell script, JavaScript.\\
\textit{Языки разметки}: XML, JSON, HTML, CSS.\\
\textit{Языки запросов}: SQL.\\
\textit{Сервера приложений}: JBoss, Apache Tomcat, Jetty.\\
\textit{Системы управления версиями}: Git, Subversion.\\
\textit{Системы сборки приложений}: Maven, Gradle, CMake.\\
\textit{Операционные системы}: OS X, Linux, Windows.\\
\textit{Другое}: Spring Framework, EJB, GWT, JQuery, MySQL, PostgreSQL, GAE.\\
\textit{Компьютерная верстка}: \TeX, \LaTeX.

\section*{Знание языков}
\textit{Русский} (родной),\\
\textit{Английский} (свободное владение).

\renewcommand{\refname}{\section*{Публикации}}
