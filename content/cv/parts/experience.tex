...
%---------------------------------------------------------
  \cventry
    ...
    {\cvhref{https://lyrasolar.com}{Lyra Solar}} % Organization
    {Remote} % Location
    {Jul. 2019 \textemdash{} PRESENT} % Date(s)
    {
      \begin{cvitems}
...
%---------------------------------------------------------
  \cventry
    {Senior software engineer} % Job title
    {\cvhref{http://foat.me}{foat.me}} % Organization
    {Worldwide} % Location
    {Feb. 2015 \textemdash{} PRESENT} % Date(s)
    {    
    Working on several own projects:
      ...
      \item{Wrote some software developments articles on a personal website: \cvhref{http://foat.me}{foat.me}. It mostly includes Scala articles.}
...
%---------------------------------------------------------
  \cventry
    {Senior software engineer} % Job title
    {\cvhref{https://www.kapitaltrading.com}{Kapital Trading}} % Organization
    {Remote} % Location
    {Aug. 2015 \textemdash{} Jun. 2019} % Date(s)
    {    
      \begin{cvitems}
      \item{Contributed to a complex multi-threaded trading system.}
      \item{Contributed to an open-source crypto currency library \cvhref{https://github.com/bitrich-info/xchange-stream}{xchange-stream}}
      \end{cvitems}
...
%---------------------------------------------------------
  \cventry
    ...
    {Remote} % Location
    {Feb. 2015 \textemdash{} Aug. 2015} % Date(s)
    {    
...
%---------------------------------------------------------
  \cventry
    ...
    {Nov. 2014 \textemdash{} Jan. 2015} % Date(s)
    {
...
%---------------------------------------------------------
  \cventry
    ...
    {Jul. 2013 \textemdash{} Sep. 2014} % Date(s)
    {
...
%---------------------------------------------------------
  \cventry
    ...
    {Kazan, Russia} % Location
    {Apr. 2013 \textemdash{} Jul. 2013} % Date(s)
    {
      \begin{cvitems_up}
...
%---------------------------------------------------------
  \cventry
    ...
    {\cvhref{http://dz.ru}{Digital Zone}} % Organization
    {Kazan, Russia} % Location
    {Sep. 2011 \textemdash{} Apr. 2013} % Date(s)
    {
