...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems_up}
      \item{Managed a small team on a mobile version of \cvhref{https://ulmart.ru}{ulmart.ru} website.}
...
%---------------------------------------------------------
  \cventry
    ...
    {
    Developed complex services for several high-loaded websites. Mostly worked on \cvhref{https://ulmart.ru}{ulmart.ru} project. Notable achievements related to this website:
      \begin{cvitems}          
